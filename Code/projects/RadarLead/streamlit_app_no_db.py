"""
RadarLead Streamlit Web Application (No Database Version)
A simple web app for finding businesses without websites using Google Places API
This version does NOT require PostgreSQL - no data is stored
"""
...
if 'places_service' not in st.session_state:
    try:
        ...
        st.error("Please set GOOGLE_PLACES_API_KEY in your .env file")
